document.addEventListener("DOMContentLoaded", function () {
                ...
                <li class="list-group-item border-0 d-flex p-4 mb-2 mt-3 bg-gray-100 border-radius-lg">
                    ...
                    <div class="ms-auto text-end">
                        <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:;" onclick="deleteUser('${userData.userID}')">
                            <i class="material-symbols-rounded text-sm me-2" style="color: #97a2c1;">delete</i>Delete
                        </a>
                     <a class="btn btn-link text-dark px-3 mb-0" href="javascript:;" onclick="editUser('${userData.userID}')">
    ...
    window.editUser = function (userID) {
        window.location.href = `/admin/client/html/updateuser.html?userID=${userID}`;
    };
